...
class CycleGANGenerator():
    ...
    def forward(self,image_path):
        ...
        generated_image = generated_image.detach().cpu().numpy()  # Tensor'ı NumPy dizisine dönüştürün
        generated_image = (generated_image + 1) / 2  # [0, 1] aralığına getirin (0 ile 1 arasında normalize edilmiş)
        generated_image = generated_image.transpose(1, 2, 0)
        generated_image = (generated_image * 255).astype(np.uint8)  # uint8 veri tipine dönüştürün
